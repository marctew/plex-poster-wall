...
/**
 * Main config table — single-row key/value-ish store with typed columns.
 */
db.exec(`
...
// Backfill columns for older DBs (ignore errors if they already exist)
